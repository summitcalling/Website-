          ...
          <div className="hidden md:flex md:items-center md:justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2.5 rounded-full bg-ink px-5 py-2.5 transition-colors hover:bg-ink-light"
              >
                <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" className="shrink-0 text-whatsapp">
