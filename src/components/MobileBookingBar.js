...
export default function MobileBookingBar({ price, message, currency = "INR" }) {
  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 rounded-t-[2.5rem] border border-b-0 border-ink/10 bg-white shadow-[0_-16px_40px_rgba(16,24,40,0.14)] lg:hidden">
